//Autor: David Patrick Zampier
//Atividade de Gerência de Memória - Sistemas Operacionais 2017
...
void *meu_aloca(int metodo, int tam){
	switch (metodo) {
		...
		case 4:
			...
			break;
		default:
			printf("\nMétodo Inválido! Executando Firstfit...\n");
			return firstfit(tam);
	}
}
...
int main(){
  ...
  mostra_mem();
	/*mostra_mem();
	void *teste = meu_aloca(3, 30);
	mostra_mem();
	void *teste2 = meu_aloca(3, 10);
	mostra_mem();
	meu_libera(teste);
	mostra_mem();
	meu_libera(teste2);
